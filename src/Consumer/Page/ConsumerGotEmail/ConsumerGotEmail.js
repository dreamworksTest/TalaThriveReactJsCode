...
import "./ConsumerGotEmail.css";
import { Link } from "react-router-dom";

const ConsumerGotEmail = ({ handleResetButton }) => {
  return (
          ...
          <div className="d-flex align-items-center inputwidthmanage">
            <div className="container passwordchangedcontainer ">
              ...
              <p className="loginlink AthleticsFont">
                Not Received? <span onClick={handleResetButton}>Resend</span>
              </p>
            </div>
          </div>
...
export default ConsumerGotEmail;
